...
quaternion intermediates~\cite{kim2025}, and isogeny degree types are
...
\begin{enumerate}
  ...
  \item \textbf{Constant-time signing.}  The specification does not
    ...
    attacks~\cite{mukherjee2025attack} demonstrate practical SPA on
...
\begin{itemize}
  \item A catalog of eight theta-coordinate bugs (\S\ref{sec:bugs})
    with root causes and lessons.
