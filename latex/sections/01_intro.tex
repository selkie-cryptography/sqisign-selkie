...
SQIsign~\cite{sqisign-spec-v3.0} is the only isogeny-based signature scheme
in Round~3 of NIST's additional signature standardization process.
Its 200-byte signatures and 83-byte public keys at NIST-I (148 and 65
bytes in the v2.0.1 parameters this implementation started from) are
smaller than any other post-quantum scheme under consideration.  But that
...
The specification~\cite{sqisign-spec-v2.0.1,sqisign-spec-v3.0} is mathematically precise but
