...
A constant of $K = 2^{16}$ provides several orders of magnitude
of headroom above anything observed on honest signatures (where
the admissible~$n$ uniformly fits in $7$~bits) and is small enough
that the verifier remains $O(1)$ on adversarial input.
