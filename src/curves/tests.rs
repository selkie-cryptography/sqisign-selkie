...
proptest! {
    ...
    #[test]
    fn curve_coefficient_roundtrip(a in arb_fp2()) {
    ...
    #[test]
    fn curve_doubling_constants_roundtrip(a in arb_fp2()) {
        let c1 = Curve::from(Coefficient::from(a));
...
proptest! {
    ...
    #[test]
    fn isogeny_degree_rejects_even(limb in any::<u64>()) {
    ...
    #[test]
    fn isogeny_degree_rejects_zero(_dummy in 0u8..1) {
        prop_assert!(IsogenyDegree::new_odd([0, 0, 0, 0]).is_none());
    }

    /// new_odd accepts odd values.
    #[test]
    fn isogeny_degree_accepts_odd(limb in any::<u64>()) {
    ...
    #[test]
    fn isogeny_degree_ordering(a in 1u64..10000, b in 1u64..10000) {
        let a_odd = a | 1;
        let b_odd = b | 1;
