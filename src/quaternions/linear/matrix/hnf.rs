//! Hermite Normal Form constructors on [`Matrix<N>`][super::Matrix].
//!
//! Classical HNF ([`Matrix::from_hnf_columns`]), modular HNF
//! ([`Matrix::from_hnf_columns_mod`], with internal widening), and the
//! C-reference-compatible variants
//! ([`Matrix::from_hnf_columns_mod_cref`] and `_v2`) used during the
//! signing response phase. See [Alg. 3.2] of the SQIsign specification.
//!
...
use super::{
    super::{super::bigint::BigInt, Vector},
    Matrix,
};
