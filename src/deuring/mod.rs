...
// curves/mod.rs. IdealToKernel (Algorithm 3.14) is inlined inside
// `compute_even_response` — see Steps 2-5 below.
...
pub fn compute_even_response(
    ...
    let m_alpha = endo_e0.apply(&alpha_conj, TorsionExponent::try_from(r_rsp).ok()?)?;
